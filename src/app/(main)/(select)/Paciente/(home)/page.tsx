...
import TreatmentsCard from '@/app/components/Patient/treatmentsCard'
import MainSection from '@/app/components/Patient/mainSection'
...
const treatments = [
  {
    ...
    icon: './svgs/ortodontia.svg',
  },
  {
    id: 2,
    name: 'Clareamento com LED Violeta',
    icon: './svgs/clareamento.svg',
  },
  {
    id: 3,
    name: 'Implante de Carga Imediata',
    icon: './svgs/implante.svg',
  },
  {
    id: 4,
    name: 'Terapia Gengival',
    icon: './svgs/terapia.svg',
  },
  {
    id: 5,
    name: 'Laserterapia par Hipersensibilidade',
    icon: './svgs/laser.svg',
  },
  {
    id: 6,
    name: 'Tratamento de Canal Automatizado',
    icon: './svgs/canal.svg',
  },
  {
    id: 7,
    name: 'Facetas com Mínimo de Desgaste',
    icon: './svgs/facetas.svg',
  },
]
...
export default function HomeClient() {
  return (
    <>
      ...
      <section className="w-full mt-12 md:mt-0 flex h-full md:h-[28.125rem] flex-col  mb-6 md:mb-0  gap-4  md:flex-row items-center justify-center ">
        <div className="flex flex-col  md:w-[35rem] ">
      ...
      <section
        id="map"
        className=" flex flex-col md:flex-row items-center w-full justify-center gap-6 mt-4"
      >
        <iframe
      ...
      <section className="bg-white py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4 xl:relative">
          <div className="bg-primary flex p-6 flex-col lg:flex-row items-center justify-evenly py-10 lg:py-14 rounded-3xl w-full">
            <div className="text-center lg:text-left mb-8 lg:mb-0">
              <h1 className="font-semibold text-white text-3xl md:text-5xl lg:text-7xl leading-normal mb-4">
                Entre em contato
              </h1>
              <p className="font-normal text-white text-sm md:text-xl">
                Tem alguma dúvida?
                <br />
            ...
            <div className="w-full md:w-auto bg-white xl:relative px-4 py-2 md:px-6 md:py-3 rounded-3xl">
              <div className="py-2 md:py-3">
                <h3 className="font-semibold text-gray-900 text-2xl md:text-3xl">
                  Mande sua mensagem!
                </h3>
              </div>
              ...
              <div className="py-2 md:py-3">
                <input
                  ...
                  className="px-3 py-3 w-full md:w-96 bg-gray-100 placeholder-gray-400 rounded-xl outline-none"
                />
              </div>
              ...
              <div className="py-2 md:py-3 relative">
                <textarea
                  ...
                  rows={4}
                  className="px-3 py-3 w-full md:w-96 bg-gray-100 placeholder-gray-400 rounded-xl outline-none resize-none"
                />

                <div className="absolute inset-y-0 right-4 md:right-auto md:left-80 ml-6 flex items-center text-xl text-gray-600">
                  <i data-feather="chevron-down"></i>
                </div>
              </div>

              <div className="py-2 md:py-3">
                <button className="w-full flex gap-4 justify-center items-center py-3 md:py-4 font-semibold text-lg text-white bg-primary rounded-xl hover:bg-highlight transition ease-in-out duration-500">
                  Enviar <MailOpen />
                </button>
              </div>
            </div>
